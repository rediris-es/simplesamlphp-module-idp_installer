 ...
 */
function simplesamlphp_module_idp_installer_hook_step9(&$data) {
    ...
    $data['info'][] = $data['ssphpobj']->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step9_finished}');    
    if (function_exists('posix_getgrnam')) {
        $aux = $data['ssphpobj']->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step9_change_perms}');
        $print = false;
    ...
    $data['info'][] = $data['ssphpobj']->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step9_remember}');
    $data['info'][] = $data['ssphpobj']->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step9_modified_files}');
    ...
    $url_init       = 'http://'.$_SERVER['HTTP_HOST'].substr($_SERVER['SCRIPT_NAME'], 0, -23) . "module.php/core/frontpage_welcome.php";
    $data['info'][] = $data['ssphpobj']->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step9_url_init}') . " <a href='$url_init' target='_blank'>" . $data['ssphpobj']->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step7_here}') . "</a></br>";
    
    $data['info'][] = $data['ssphpobj']->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step9_remember_cert}').'<i>'.$cert_path.'</i>';
