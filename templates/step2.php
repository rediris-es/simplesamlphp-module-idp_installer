...
<form action="" method="post">    
    <h4><?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_access_title}'); ?></h4>
    <input type="hidden" name="step" value="<?php echo $next_step; ?>">
    <?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_access_password}'); ?><br/>
    <input type="password" value="" name="ssphp_password" style="width:200px;"><br/>
    <?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_access_password2}'); ?><br/>
    <input type="password" value="" name="ssphp_password2" style="width:200px;"><br/>

    <h4><?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_contact_title}'); ?></h4>
    <?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_contact_name}'); ?>:<br/>
    <input type="text" value="" name="ssphp_technicalcontact_name" style="width:300px;"><br/>
    <?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_contact_email}'); ?>:<br/>
    <input type="text" value="" name="ssphp_technicalcontact_email" style="width:300px;"><br/>
    <p><?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_contact_info}'); ?></p>
    
    <h4><?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_organization_title}'); ?></h4>
    <?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_organization_name}'); ?>:<br/>
    <input type="text" value="" name="ssphp_organization_name" style="width:300px;"><br/>
    <?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_organization_description}'); ?>:<br/>
    <input type="text" value="" name="ssphp_organization_description" style="width:300px;"><br/>
    <?php echo $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:step2_organization_info_url}'); ?>:<br/>
