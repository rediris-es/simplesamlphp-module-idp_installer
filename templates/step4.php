...
drawButton(5, $this->t('{simplesamlphp-module-idp-installer:simplesamlphp-module-idp-installer:try_again_button}'), 'style="margin-top:20px;float:left;margin-right:10px;"');
?>
