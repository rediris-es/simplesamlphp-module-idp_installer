...
drawButton(5, $this->t('{simplesamlphp_module_idp_installer:simplesamlphp_module_idp_installer:try_again_button}'), 'style="margin-top:20px;float:left;margin-right:10px;"');
?>
